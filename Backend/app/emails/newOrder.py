              ...
              <tr>
                <td>
                  <div class="text" style="padding: 0 3em; text-align: center;">
                    <h3>Launchapp - New Order</h3>
                     <p  style="padding: 0 3em;text-align: left;"> Hi {},</p>
                     <p style="padding: 0 3em;text-align: left;">
                     Thank you for using LaunchApp. You order for food {} have place at {}. 
...
def getEmailMessage(foodName: str, time: str):
    return ''.join([ header, body.format(foodName, time), footer])

def newOrder(userEmail:str, foodName:str, time: str):
    subject:str ="LaunchApp New Order"
    message = getEmailMessage(foodName, time)
