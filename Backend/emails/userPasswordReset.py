              ...
              <tr>
                <td>
                  <div class="text" style="padding: 0 3em; text-align: center;">
                    <h3>LaunchApp - Password Recovery</h3>
                     <p  style="padding: 0 3em;text-align: left;"> Hi {},</p>
                     <p style="padding: 0 3em;text-align: left;">
                     Thank you for using LaunchApp. Click on the link below to reset our password. 
...
def getEmailMessage(userName: str):
    return ''.join([ header, body.format(userName), footer])

def passwordRevovery(userEmail:str, userName: str):
    subject:str ="LaunchApp Password Recovery"
    message = getEmailMessage(userName)
